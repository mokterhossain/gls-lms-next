...
-- CreateEnum
CREATE TYPE "CrudAction" AS ENUM ('CREATE', 'READ', 'UPDATE', 'DELETE');
...
CREATE TABLE "PolicyRole" (
    ...
    CONSTRAINT "PolicyRole_pkey" PRIMARY KEY ("policyId","roleId")
);
...
-- CreateIndex
CREATE INDEX "Policy_moduleId_idx" ON "Policy"("moduleId");
...
-- AddForeignKey
ALTER TABLE "Policy" ADD CONSTRAINT "Policy_moduleId_fkey" FOREIGN KEY ("moduleId") REFERENCES "Module"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PolicyRole" ADD CONSTRAINT "PolicyRole_policyId_fkey" FOREIGN KEY ("policyId") REFERENCES "Policy"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PolicyRole" ADD CONSTRAINT "PolicyRole_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "Role"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PolicyUser" ADD CONSTRAINT "PolicyUser_policyId_fkey" FOREIGN KEY ("policyId") REFERENCES "Policy"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PolicyUser" ADD CONSTRAINT "PolicyUser_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
